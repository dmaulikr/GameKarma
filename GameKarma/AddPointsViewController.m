...
- (IBAction)addKarmaPoints:(id)sender {
    ...
    PFObject *gameScore = [PFObject objectWithClassName:@"Karma"];
...
- (void)gotTOLoginPage {
    ...
    if (![PFUser currentUser]) { // No user logged in
        ...
        PFLogInViewController *logInViewController = [[PFLogInViewController alloc] init];
         [logInViewController.logInView setLogo:[[UIImageView alloc] initWithImage:[UIImage imageNamed:@"karma.jpg"]]];
...
- (IBAction)gotoToalView:(id)sender {
